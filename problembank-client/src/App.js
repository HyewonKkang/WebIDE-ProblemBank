...
const ContestMainPage = React.lazy(() => import('./pages/Contest'))
const ContestStartPage = React.lazy(() => import('./pages/ContestStart'))
const ContestFinishPage = React.lazy(() => import('./pages/ContestFinish'))
      ...
      <Suspense fallback = {<Loading type={'bars'} color={'black'} />}>
        <BrowserRouter>
            <Switch>
                ...
                <Route path = "/contest" component = {ContestMainPage}/>
                <Route path = "/conteststart" component = {ContestStartPage}/>
                <Route path = "/contestfinish" component = {ContestFinishPage}/>
